...
namespace livrocsharp
{
    class FuncoesTexto
    {
        static void Main(string[] args)
        {
            ...
            WriteLine("TRIM - retire os espaços em branco antes e após a expressão");
            ...
            WriteLine("ToUpper - converter todos os caracteres para maíusculo");
            WriteLine($"Converte para maiúsculo: {empresa.ToUpper()}");

            WriteLine("ToLower - Converter todos os caracteres para minúsculos");
